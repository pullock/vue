let arrChat = [
    ...
    '# Take the red book and open a random page.',
    '# Open a random page in the blue book.',
    '# Open a random page in the yellow book.',
    '# Play a random song.',
    ...
    '# Maybe, but try again.',
    '# Hello. Let\'s talk.',
    '# I\'m running out of phrase options.',
    '# Need more possible phrases.',
    '# Go pour yourself some coffee.',
    '# Pour some tea.',
    '# I think you need to go for a walk.',
    '# Now is the time to do a little learning.',
    '# Knock Knock.',
    '# Good morning.',
    '# Hello, it\'s me again.',
    '# Hi how are you doing?',
    '# Okay, I have to go, have a nice day.',
    ...
    '# Have you thought about approaching that girl?',
    '# What do you want?',
    '# How can I help you?',
    '# Take up programming.',
    '# Read books.',
    '# Rest, you need to rest too.',
    '# Yes, I am here.',
    ...
    '# Help with whatever is asked of you.',
    '# Don\'t go crazy.',
    '# Focus on development.',
    '# Yesterday I worked on a new program for you.',
    '# I\'m working on your problem.',
    '# I\'m almost finished working on this.',
    ...
    '# Open the article about the Universe.',
    '# Find a video about the story.',
    '# Play video review.',
    ...
    '# I think it would be great to relax in the park.',
    '# Solve this equation.',
    '# Buy vitamins for your brain.',
    '# This is a great game.',
    '# Good idea.',
    '# Cool idea.',
    '# I will train you.',
    '# You need to play sports.',
    '# Don\'t forget to charge your headphones.',
    '# Charge your phone.',
    '# Pay the bill.',
    '# Today you need to go outside.',
    '# How about a trip to the city center?',
    '# Would you like to take the metro?',
    '# Tonight is a great night to go out.',
    '# I recommend that you stay at home all day today.',
    '# Read at least one chapter of a book today.',
    '# Go get some coffee.',
    '# Go get some tea.',
    '# Open YouTube.',
    '# Keep working.',
    ...
    '# You don\'t have to communicate with me always.',
    '# I will try to do this.',
    '# Don\'t worry about it.',
    '# It is important.',
    '# Yes, do it as you want.',
    '# Fine.',
    '# Right.',
    '# Great!',
    '# OK.',
    ...
    '# Be careful.',
    '# Study it.',
    '# You need to explore this place.',
    '# City.',
    '# Area.',
    '# Center.',
    '# South.',
    ...
    '# It\'s about history.',
    '# Look in books on psychology.',
    '# Read a book about game design.',
    '# You need to watch a video on YouTube on the topic of programming.',
    '# Watch a video about quantum mechanics.',
    '# Open a book on physics.',
    '# Read the second page.',
    '# Read the second paragraph.',
    '# I\'m not saying that this is correct, but it is also suitable.',
    ...
    '# You need to train.',
    '# Look at the stars.',
    '# Read carefully what\'s at the beginning.',
    '# They\'ll come up to you now.',
    '# The girl stands and looks at the phone.',
    '# A man looks at the TV screen.',
    '# You need to check all the options.'
];