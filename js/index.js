...
let arrChat = [
    ...
    'You can write site markup and add styles.',
    'What\'s cool is that you can run any program.',
    'Your cognitive abilities are constantly growing, which is great.',
    'You need to restart your computer to install the update.',
    'Here you need to download the missing data package and install it.',
    'Create a folder at the second nesting level.',
    'You need to download all files from this archive.',
    'Use a compiler to convert the code into machine code.',
    'You need to make a flexible and adaptive design for this site.',
    'Today we will develop a design for a website for a construction company.',
    'We agreed that we would meet at the office at noon.',
    'I think you think correctly, but you lack education.',
    'I\'m going to get the best higher education in this country.',
];